...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Adams[/B][/COLOR]Wizard'
BUILDERNAME = 'OpenWizard'
EXCLUDES = [ADDON_ID, 'repository.adamsbuilds']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/adamsbuilds/repo/master/zips/builds.txt'
...
REPOID = 'repository.adamsbuilds'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/adamsbuilds/repo/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/adamsbuilds/repo/master/zips/plugin.program.adamswizard'
#########################################################
